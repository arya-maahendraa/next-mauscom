...
var YoutubeComment = /** @class */ (function () {
     ...
     */
    YoutubeComment.prototype.getComment = function (videoId, count, nextPageToken) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, axios_1.default)({
                                method: "get",
                                baseURL: config_1.default.youtubeAPI.url,
                                url: "/commentThreads",
                                headers: {
    ...
    YoutubeComment = __decorate([
        (0, typedi_1.Service)()
    ], YoutubeComment);
    return YoutubeComment;
}());
exports.default = YoutubeComment;
